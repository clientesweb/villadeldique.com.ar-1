...
export default function PromotionalBanner() {
  ...
  return (
    <>
      <section className="py-4 md:py-6 px-4 bg-brand-navy">
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-6">
            <div className="text-left flex-1 w-full md:w-auto">
              <h2 className="font-serif text-lg md:text-xl lg:text-2xl font-bold mb-1 md:mb-2 text-white">
            ...
            <div className="flex-shrink-0 w-full md:w-auto">
              <div className="bg-black/20 backdrop-blur-sm rounded-xl p-3 md:p-4 border border-white/10">
                ...
                >
                  <svg
                    className="w-6 h-6 md:w-8 md:h-8 flex-shrink-0 text-brand-yellow"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                  >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-brand-navy rounded-xl p-4 md:p-6 border border-white/10 shadow-xl max-w-sm md:max-w-md w-full relative animate-in zoom-in-95 duration-200 max-h-[90vh] overflow-y-auto">
            <button
              onClick={() => setIsModalOpen(false)}
              className="absolute top-3 right-3 md:top-4 md:right-4 p-2 rounded-lg hover:bg-white/10 transition-colors"
            >
            ...
            <div className="mb-4 md:mb-6 pr-8">
              <h3 className="font-serif text-lg md:text-xl font-bold text-white mb-1 md:mb-2">
            ...
            <div className="space-y-3 md:space-y-4">
              <div className="bg-black/20 rounded-lg p-3 md:p-4 space-y-2 md:space-y-3">
                ...
                <div className="text-sm space-y-1 md:space-y-2 text-white">
                  <div>
