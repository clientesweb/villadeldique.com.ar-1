        ...
        <section className="py-12 px-4 md:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center max-w-4xl mx-auto">
              <button
                className="bg-brand-navy text-white px-8 py-4 rounded-lg font-sans font-semibold text-lg hover:bg-brand-navy/90 transition-colors duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 w-full sm:w-auto text-center cursor-not-allowed opacity-75"
                aria-label="Información turística oficial (temporalmente no disponible)"
                disabled
              >
