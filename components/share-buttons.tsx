...
export default function ShareButtons({ title, url, description }: ShareButtonsProps) {
  ...
  return (
    <div className="bg-gray-50 p-4 md:p-6 rounded-lg">
      <h3 className="font-serif text-lg font-bold text-brand-navy mb-4">Compartir esta noticia</h3>
      <div className="flex flex-wrap gap-3">
        ...
        {navigator.share && (
          <button
            ...
            className="flex items-center gap-2 bg-brand-blue text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
